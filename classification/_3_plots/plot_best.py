...
runs_folder = "runs/best"

# Best models are mm_42 (Baseline) and mmfv7_1 (Best MMF)
...
# or "Val/epoch/accuracy", "Train/epoch/accuracy", "Learning_rate"
metric_name = "Learning_rate"

# For plot titles and filenames
metric_plot_name = "Baseline vs Best MMF Model Learning Rate"
